...
class PuppetManager {
    static resolve(options) {
        return __awaiter(this, void 0, void 0, function* () {
            config_1.log.verbose('PuppetManager', 'resolve({wechaty: %s, puppet: %s, puppetOptions: %s})', options.wechaty, options.puppet, JSON.stringify(options.puppetOptions));
            if (!options.puppet || options.puppet === 'default') {
                options.puppet = puppet_config_1.PUPPET_DEFAULT;
            }
