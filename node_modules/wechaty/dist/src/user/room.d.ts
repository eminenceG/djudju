...
export declare class Room extends Accessory implements Sayable {
    ...
    emit(event: 'leave', leaverList: Contact[], remover?: Contact): boolean;
    emit(event: 'join', inviteeList: Contact[], inviter: Contact): boolean;
    emit(event: 'topic', topic: string, oldTopic: string, changer: Contact): boolean;
    emit(event: never, ...args: never[]): never;
    on(event: 'invite', listener: (this: Room, inviter: Contact, invitation: RoomInvitation) => void): this;
    on(event: 'leave', listener: (this: Room, leaverList: Contact[], remover?: Contact) => void): this;
