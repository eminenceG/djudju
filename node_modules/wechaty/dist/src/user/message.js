...
class Message extends accessory_1.Accessory {
     ...
     * .start()
     */
    say(textOrContactOrFileOrUrl, mention) {
        return __awaiter(this, void 0, void 0, function* () {
            config_1.log.verbose('Message', 'say(%s%s)', textOrContactOrFileOrUrl, mention
                ? ', ' + mention
                : '');
            ...
            if (typeof textOrContactOrFileOrUrl === 'string') {
                yield this.sayText(textOrContactOrFileOrUrl, from || undefined, room || undefined, mentionList);
            }
    ...
    sayText(text, to, room, mentionList) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    mention() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const AT_SEPRATOR = config_1.FOUR_PER_EM_SPACE;
