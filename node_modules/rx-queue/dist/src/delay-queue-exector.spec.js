...
test('DelayQueueExector execute once', (t) => __awaiter(this, void 0, void 0, function* () {
    const spy = sinon.spy();
...
test('DelayQueueExector execute thrice', (t) => __awaiter(this, void 0, void 0, function* () {
    const spy = sinon.spy();
    const delay = new DelayExector(DELAY_PERIOD_TIME);
